...
<ul>
  ...
  <li class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="film_category_insert.php">Insert</a>
   	  <a href="film_category_update.php">Update</a>
      <a href="film_category_delete.php">Delete</a>
   	  <a href="film_category_search.php">Search</a>
    </div>
  </li>
</ul>
<div class="container-table100">
    <div class="wrap-table100cat">
        <div class="table100">
        <h6 style="font-size:30px;color:white;font-family:verdana"><b><center>Film_Category</center></b></h6>
        <br>
            <table>
                <thead>
                ...
                <?php
                    ...
                    if ($resultCheck > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<tr><td class=column1>" . $row['film_id'] . "</td><td>" . $row['category_id'] . "</td><td>" . $row['last_update'] . "</td></tr>";
                        }
                    }
