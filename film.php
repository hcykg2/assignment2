...
<ul>
  ...
  <li class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="film_delete.php">Delete</a>
                ...
                <?php
                    ...
                    if ($resultCheck > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<tr><td class=columnadd1>" . $row['film_id'] . "</td><td class=columnadd1>" . $row['release_year'] . "</td><td class=columnadd1>" .  $row['language_id'] . "</td><td>" . $row['original_language_id'] . "</td><td class=columnadd1>" .  $row['rental_duration'] . "</td><td class=columnadd1>" .  $row['rental_rate'] . "</td><td class=columnadd1>" .  $row['length'] . "</td><td class=columnadd1>" .  $row['replacement_cost'] . "</td><td>" .  $row['rating'] . "</td><td>" . $row['last_update'] . "</td></tr>";
                        }
                    }
