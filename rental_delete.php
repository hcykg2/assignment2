...
<ul>
  ...
  <li><a href="rental.php">Back</a></li>
</ul>
            ...
            <table>
                ...
                <?php
                    ...
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
                            <td class=column1>      <?php echo $row['rental_id']   ?></td>
                            <td>                    <?php echo $row['rental_date'] ; ?></td>
                            <td class=columnadd1>   <?php echo $row['inventory_id'];    ?></td> 
                            <td class=columnadd1>   <?php echo $row['customer_id'];   ?></td>
                            <td>                    <?php echo $row['return_date'];      ?></td>
                            <td>                    <?php echo $row['staff_id'];?></td>
                            <td class=columnadd1>   <?php echo $row['last_update']; ?></td>
                            <td>
                                <a href= "rental_delete.php?delete=<?php echo $row['rental_id'];   ?>"class= btn btn-danger>Delete</a>
                            </td>
                        </tr>  
                    <?php endwhile; ?>
                </tbody>
