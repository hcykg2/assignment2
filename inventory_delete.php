...
<ul>
  ...
  <li><a href="inventory.php">Back</a></li>
</ul>
            ...
            <table>
                ...
                <?php
                    ...
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
                            <td class=column1>      <?php echo $row['inventory_id'];?></td>
                            <td class=columnadd1>   <?php echo $row['film_id'];     ?></td>
                            <td class=columnadd1>   <?php echo $row['store_id'];    ?></td> 
                            <td>                    <?php echo $row['last_update']; ?></td>
                            <td>
                                <a href= "inventory_delete.php?delete=<?php echo $row['inventory_id'];   ?>" class= btn btn-danger>Delete</a>
                            </td>
                        </tr>  
                <?php endwhile; ?>
