        ...
        <div class="panel-body">
          <form action="film_insert.php" method="post">
            ...
            <div class="form-group">
              <label for="film_id">customer_id</label>
...
$sql = "INSERT INTO `film` (`film_id`, `release_year`, `language_id`, `rental_duration`, `rental_rate`, `length`, `replacement_cost`, `rating`) VALUES ('$film_id', '$language_id', '$rentalDuration', '$rentalRate', '$length', '$replacement_cost', '$rating')";
