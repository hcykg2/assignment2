...
<ul>
  ...
  <li>
      <form method="POST" style="display:inline-block;">Country ID: <input type="number" name="id" placeholder="enter address id"><input type="submit" name="submit" value="submit"></form>
  </li>
</ul>
                ...
                <?php
                    ...
                    if ($resultCheck > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<tr><td class=column1>" . $row['country_id'] . "</td><td>" . $row['country'] . "</td><td>" . $row['last_update'] . "</td></tr>";
                        }
                    }
