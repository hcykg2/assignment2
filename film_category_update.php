...
<head>
	<meta charset="UTF-8">
	<title>Update film_category</title>
    ...
    <div class="row col-md-6 col-md-offset-3">
      <div class="panel panel-primary">
        ...
        <div class="panel-heading text-center">
          <h1>Update film_category</h1>
        </div>

        <div class="panel-body">
          <form action="film_category_update.php" method="post">
...
$sql = "UPDATE film_category SET `film_id`='$film_id', `category_id`= '$category_id' WHERE `film_id`='$film_id' AND `category_id`='$category_id'";
