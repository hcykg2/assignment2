...
<ul>
  ...
  <li>
      <form method="POST" style="display:inline-block;">Actor ID: <input type="number" name="id" placeholder="enter address id"><input type="submit" name="submit" value="submit"></form>
  </li>
</ul>
    ...
    <div class="wrap-table100cat">
        ...
        <br>
            <table>
                ...
                <?php
                    $id = $_POST['id'];
                    $sql = "SELECT * FROM film_actor WHERE actor_id = $id;";
