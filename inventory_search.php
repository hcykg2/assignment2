...
<ul>
  ...
  <li>
      <form method="POST" style="display:inline-block;">Inventory ID: <input type="number" name="id" placeholder="enter address id"><input type="submit" name="submit" value="submit"></form>
  </li>
</ul>
